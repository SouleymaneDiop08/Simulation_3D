...
public class PlcLink : MonoBehaviour
{
        ...
        ref int tractionPrec, ref bool fsPrec, ref bool fuPrec)
    {
        ...
        // ---- Vitesse autorisee (km/h, telle qu'emise par l'automate) ----
        train.vitesseAutorisee = vitesseLimite;

        // ---- Freins et traction ----
        // ChangerTraction() remet l'etat de frein a "relache" : on ne
        // l'appelle donc que si aucun frein n'est commande, sinon l'ordre
        // de freinage serait annule au cycle suivant.
